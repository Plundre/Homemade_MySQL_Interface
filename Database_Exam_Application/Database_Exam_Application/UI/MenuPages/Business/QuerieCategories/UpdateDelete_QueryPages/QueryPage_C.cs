        ...
        internal override void Run() {
            while(true) {
                ...
                if(choice.ToLower() == "u" || choice == "") {
                    ...
                    result = coVidRental.business.DataUpdateDelete_c_Update(order_number, branch_number, supplier_number, supplier_street, supplier_city, supplier_state, supplier_zip_code, video_catalog_number, video_title, video_purchase_price, quantity, date_order_placed, date_order_received, branch_street, branch_city, branch_state, branch_zip_code);

                } else if(choice.ToLower() == "d") {

                    MenuRender("video_number:");
                    Draw();
                    IntegerInputSanitation(out order_number);

                    result = coVidRental.business.DataUpdateDelete_c_Delete(order_number);
