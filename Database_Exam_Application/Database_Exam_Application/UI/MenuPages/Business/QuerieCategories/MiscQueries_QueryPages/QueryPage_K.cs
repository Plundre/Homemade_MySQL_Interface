...
namespace Database_Exam_Application.UI.MenuPages.Business.QuerieCategories.MiscQueries_QueryPages {
    internal class QueryPage_K : Page {
        ...
        public QueryPage_K(CoVidRental.CoVidRental coVidRental, string caseMenu) {
        ...
        internal override void Run() {
            while(true) {
                ...
                ResultRender(coVidRental.business.DataMiscQuerie_k(supplier_number));
