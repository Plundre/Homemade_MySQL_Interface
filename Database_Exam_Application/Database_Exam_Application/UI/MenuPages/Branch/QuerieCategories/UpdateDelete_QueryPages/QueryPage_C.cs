        ...
        internal override void Run() {
            while(true) {
                ...
                if(choice.ToLower() == "u" || choice == "") {
                    ...
                    result = coVidRental.branch.DataUpdateDelete_c_Update(video_number, staff_number, catalog_number, supplier_number, title, category, daily_rental_rate, purchase_price, status_, main_character_name, main_actor_name, director, branch_number);
                    ...
                    result = coVidRental.branch.DataUpdateDelete_c_Delete(video_number);
