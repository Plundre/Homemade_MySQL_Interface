    ...
    internal class QueryPage_D : Page {
        ...
        internal override void Run() {
            while(true) {
                ...
                ResultRender(coVidRental.branch.DataEntry_d(video_number, staff_number, catalog_number, supplier_number, title, category, daily_rental_rate, purchase_price, status_, main_character_name, main_actor_name, director, branch_number));
